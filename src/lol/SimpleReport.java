...
public class SimpleReport {    
    ...
    public SimpleReport() {
        ...
        TableModelData();
        try {
            JasperCompileManager.compileReportToFile("newReport.jrxml");
            jasperPrint = JasperFillManager.fillReport("newReport.jasper", new HashMap(), new JRTableModelDataSource(tableModel));
